...
export async function findDeviceNicknameMatch(supabase, fp, options = {}){
  ...
  try{
    ...
    return { ok:true, matched:true, user_id:profile.user_id, display_name:displayName, confidence_score:best.score, device_hash:best.device_hash, enhanced, suggestions };
  }catch(err){
