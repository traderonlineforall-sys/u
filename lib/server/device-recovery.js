...
const MAX_CHOICES = 3;
// A single strong candidate still needs an explicit, signed confirmation on
// first enrollment. Requiring two candidates made the safe recovery flow
// unreachable for the common case where a device has exactly one owner.
const MIN_CHOICES = 1;
