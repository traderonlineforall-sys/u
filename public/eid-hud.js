...
const LEGACY_THEME_HREF = "ua07-20-theme.css?v=ua07legacy6-transparent-menu-redo";
const AHLY_THEME_LINK_ID = "ahlyPremiumThemeLink";
const AHLY_THEME_HREF = "ahly-premium-theme.css?v=ahly-v12-transparent-menu-redo";
