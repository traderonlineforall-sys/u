(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '.mndo-search-logo-row #' + SEARCH_HK_COL_ID + ' .search-container > #' + LINE_ID + '{display:none;position:absolute;left:0;top:calc(100% + 1px);min-width:300px;max-width:400px;font-size:12px;text-align:center;z-index:1;pointer-events:auto;user-select:text;color:rgba(255,255,255,.88);text-shadow:0 1px 2px rgba(0,0,0,.55);white-space:normal;overflow:visible;isolation:isolate;width:100%;margin:0;}',
