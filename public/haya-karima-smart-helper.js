(function () {
  ...
  function renderFromInput() {
    ...
    var html = '<span class="hk-ready">حياه كريمة الرسمي</span><span class="hk-sep">•</span><span class="hk-ready">' + label + '</span><span class="hk-sep">•</span><a class="hk-link" href="' + url + '" target="_blank" rel="noopener noreferrer">فتح النتيجة</a>';
