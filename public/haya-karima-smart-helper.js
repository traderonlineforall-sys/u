(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '#' + LINE_ID + ' .hk-button{display:inline-flex;align-items:center;justify-content:center;min-width:42px;height:24px;padding:0 11px;border-radius:999px;border:1px solid rgba(255,255,255,.22);background:linear-gradient(180deg, rgba(255,255,255,.18), rgba(255,255,255,.07));box-shadow:inset 0 1px 0 rgba(255,255,255,.18),0 0 0 1px rgba(255,255,255,.06),0 8px 20px rgba(0,0,0,.22),0 0 16px rgba(255,255,255,.10);text-decoration:none;color:#ffffff;font-weight:800;letter-spacing:.1em;text-shadow:0 0 10px rgba(255,255,255,.30),0 1px 2px rgba(0,0,0,.55);flex:0 0 auto;cursor:pointer;transition:border-color .18s ease, box-shadow .18s ease, transform .18s ease, background .18s ease;}',
      '#' + LINE_ID + ' .hk-button:hover{border-color:rgba(255,255,255,.40);background:linear-gradient(180deg, rgba(255,255,255,.24), rgba(255,255,255,.09));box-shadow:inset 0 1px 0 rgba(255,255,255,.22),0 0 0 1px rgba(255,255,255,.08),0 10px 24px rgba(0,0,0,.24),0 0 22px rgba(255,255,255,.14);transform:translateY(-1px);}',
      '#' + LINE_ID + ' .hk-button:focus{outline:none;box-shadow:0 0 0 3px rgba(255,255,255,.10),inset 0 1px 0 rgba(255,255,255,.22),0 10px 24px rgba(0,0,0,.24),0 0 22px rgba(255,255,255,.14);}',
      '#' + LINE_ID + ' .hk-raw{flex:1 1 auto;min-width:0;width:100%;height:24px;padding:0 12px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:linear-gradient(180deg, rgba(20,27,44,.90), rgba(8,11,20,.82));box-shadow:inset 0 1px 0 rgba(255,255,255,.08),inset 0 -1px 0 rgba(255,255,255,.03);color:#ffffff;font:inherit;font-weight:800;letter-spacing:.01em;direction:ltr;text-align:left;caret-color:#ffffff;-webkit-user-select:text;user-select:text;cursor:text;transition:border-color .16s ease, box-shadow .16s ease, color .16s ease, text-shadow .16s ease, background .16s ease;}',
      '#' + LINE_ID + ' .hk-raw::placeholder{color:rgba(255,255,255,.86);font-weight:800;text-shadow:0 0 8px rgba(255,255,255,.16);}',
      '#' + LINE_ID + ' .hk-raw:focus{outline:none;border-color:rgba(255,255,255,.30);box-shadow:0 0 0 3px rgba(255,255,255,.07),inset 0 1px 0 rgba(255,255,255,.10),0 0 18px rgba(255,255,255,.06);}',
      '#' + LINE_ID + ' .hk-raw.is-ok{color:#f3fff8;border-color:rgba(124,255,177,.54);background:linear-gradient(180deg, rgba(15,52,33,.92), rgba(7,24,17,.90));box-shadow:0 0 0 1px rgba(124,255,177,.12),inset 0 1px 0 rgba(255,255,255,.08),0 0 18px rgba(124,255,177,.16);text-shadow:0 0 10px rgba(124,255,177,.32),0 0 2px rgba(255,255,255,.35);}',
      '#' + LINE_ID + ' .hk-raw.is-bad{color:#fff2f2;border-color:rgba(255,134,134,.58);background:linear-gradient(180deg, rgba(64,20,24,.92), rgba(24,9,12,.90));box-shadow:0 0 0 1px rgba(255,134,134,.14),inset 0 1px 0 rgba(255,255,255,.07),0 0 18px rgba(255,134,134,.16);text-shadow:0 0 10px rgba(255,134,134,.34),0 0 2px rgba(255,255,255,.28);}',
      '#' + LINE_ID + ' .hk-raw.is-warn{color:#ffffff;border-color:rgba(255,255,255,.28);background:linear-gradient(180deg, rgba(26,31,46,.92), rgba(9,12,22,.88));box-shadow:0 0 0 1px rgba(255,255,255,.06),inset 0 1px 0 rgba(255,255,255,.08),0 0 14px rgba(255,255,255,.07);text-shadow:0 0 8px rgba(255,255,255,.22),0 0 2px rgba(255,255,255,.18);}',
